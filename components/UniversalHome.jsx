...
async function fetchCountsMy(uid) {
  ...
  const [feedMy, allMy, newMy, progressMy] = await Promise.all([
    ...
    fetchCount((q) => q.eq('assigned_to', uid).or('status.is.null,status.eq.Ð ÑœÐ Ñ•Ð Ð†Ð¡â€¹Ð â„–')),
    fetchCount((q) => q.eq('assigned_to', uid).eq('status', 'Ð â€™ Ð¡Ð‚Ð Â°Ð Â±Ð Ñ•Ð¡â€šÐ Âµ')),
  ]);
...
async function fetchCountsAll() {
  ...
  const [feedAll, allAll, newAll, progressAll] = await Promise.all([
    fetchCount((q) => q.is('assigned_to', null)),
    fetchCount((q) => q),
    fetchCount((q) => q.or('status.is.null,status.eq.Ð ÑœÐ Ñ•Ð Ð†Ð¡â€¹Ð â„–')),
    fetchCount((q) => q.eq('status', 'Ð â€™ Ð¡Ð‚Ð Â°Ð Â±Ð Ñ•Ð¡â€šÐ Âµ')),
  ]);
...
export default function UniversalHome({ role, user, profile: providedProfile }) {
  ...
  // Ð Â Ð¡â€™Ð Â Ð¢â€˜Ð Â Ð¡Â˜Ð Â Ð¡â€˜Ð Â Ð â€¦ Ð Â Ð’Â±Ð Â Ð’ÂµÐ Â Ð’Â· Ð Â Ð¡â€¢Ð Â Ð’Â¶Ð Â Ð¡â€˜Ð Â Ð¢â€˜Ð Â Ð’Â°Ð Â Ð â€¦Ð Â Ð¡â€˜Ð ÐŽÐ Ð Ð Â Ð¡â€”Ð Â Ð’ÂµÐ ÐŽÐ â€šÐ Â Ð¡Â˜Ð Â Ð¡â€˜Ð ÐŽÐ²â€šÂ¬Ð Â Ð’ÂµÐ Â Ð â€¦Ð Â Ð¡â€¢Ð Â Ð â€ 
  const isAdmin = resolvedRole === 'admin';

  // Ð Â Ð¡â€ºÐ Â Ð’Â±Ð Â Ð’Â»Ð Â Ð’Â°Ð ÐŽÐ Ñ“Ð ÐŽÐ²Ð‚Ñ™Ð ÐŽÐ Ð‰ Ð Â Ð¡â€”Ð ÐŽÐ â€šÐ Â Ð¡â€¢Ð ÐŽÐ Ñ“Ð Â Ð¡Â˜Ð Â Ð¡â€¢Ð ÐŽÐ²Ð‚Ñ™Ð ÐŽÐ â€šÐ Â Ð’Â°
  const canViewAll = isAdmin || (!permsLoading && has?.('canViewAllOrders') === true);

’Â˜ Ð ÐŽÐ â€šÐ Â Ð¡â€¢Ð Â Ð’Â»Ð ÐŽÐ Ð‰ Ð Â Ð¡â€¢Ð Â Ð¡â€”Ð ÐŽÐ â€šÐ Â Ð’ÂµÐ Â Ð¢â€˜Ð Â Ð’ÂµÐ Â Ð’Â»Ð Â Ð’ÂµÐ Â Ð â€¦Ð Â Ð’Â°
  // profileLoading Ð Â Ð¡ÑšÐ Â Ð²Ð‚Ñž Ð Â Ð’Â±Ð Â Ð’Â»Ð Â Ð¡â€¢Ð Â Ð¡â€Ð Â Ð¡â€˜Ð ÐŽÐ â€šÐ ÐŽÐ¡â€œÐ Â Ð’ÂµÐ ÐŽÐ²Ð‚Ñ™ Ð ÐŽÐ Ñ“Ð ÐŽÐ²Ð‚ÐŽÐ Â Ð’ÂµÐ ÐŽÐ²Ð‚Ñ™Ð ÐŽÐ²Ð‚ÐŽÐ Â Ð¡â€˜Ð Â Ð¡â€Ð Â Ð¡â€˜ - Ð Â Ð¡â€¢Ð Â Ð â€¦Ð Â Ð¡â€˜ Ð Â Ð¡Â˜Ð Â Ð¡â€¢Ð Â Ð¡â€“Ð ÐŽÐ¡â€œÐ ÐŽÐ²Ð‚Ñ™ Ð Â Ð’Â·Ð Â Ð’Â°Ð Â Ð¡â€“Ð ÐŽÐ â€šÐ ÐŽÐ¡â€œÐ Â Ð’Â¶Ð Â Ð’Â°Ð ÐŽÐ²Ð‚Ñ™Ð ÐŽÐ Ð‰Ð ÐŽÐ Ñ“Ð ÐŽÐ Ð Ð Â Ð¡â€”Ð Â Ð’Â°Ð ÐŽÐ â€šÐ Â Ð’Â°Ð Â Ð’Â»Ð Â Ð’Â»Ð Â Ð’ÂµÐ Â Ð’Â»Ð ÐŽÐ Ð‰Ð Â Ð â€¦Ð Â Ð¡â€¢
  ...
  // ====== Ð Â Ð¡ÑšÐ Â Ð’Â°Ð Â Ð â€ Ð Â Ð¡â€˜Ð Â Ð¡â€“Ð Â Ð’Â°Ð ÐŽÐ²Ð‚Â Ð Â Ð¡â€˜Ð ÐŽÐ Ð ======
  ...
  const openCreateOrder = useCallback(() => {
    if (isReadOnlyBySubscription) {
      toast.warning(
        t('subscription_create_unavailable_toast', 'Ð¡Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð·Ð°ÑÐ²ÐºÐ¸ Ð½ÐµÐ´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾'),
      );
      return;
    }
  ...
  const initials = useMemo(() => {
    ...
    const fromFull = (fullName || '')
      ...
      .slice(0, 2)
      .join('');
    return (a + b || fromFull || 'Ð²Ð‚Ñž').toUpperCase();

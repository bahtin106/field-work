import React, { useEffect, useState } from 'react'
    import { View, Text, StyleSheet, ActivityIndicator, Pressable } from 'react-
native'
      ...
      if (blocked) {
        return (
          <View style={styles.blocked}>
            ...
            <Pressable onPress={logout} style={({pressed}) => [styles.appButton,
 styles.btnDanger, pressed && {transform:[{scale:0.98}]}]}>
      ...
      return (
        <View style={styles.container}>
          ...
          <Text style={styles.text}>Вы можете управлять заявками и назначать 
исполнителей.</Text>

...
export default function CalendarScreen() {
  ...
  const calendarContentStyle = useAnimatedStyle(
    () => ({
      height: (() => {
        ...
        const monthHeaderVisibleHeight = measuredMonthHeaderHeight * (1 - progress);
  ...
  }, [actualWeekRows, measuredWeekRowHeight, monthCollapsePhaseSplit, selectedWeekIndex]);
  ...
  const ordersMonthGesture = Gesture.Pan()
    ...
    .failOffsetY([-gestureFailOffsetX, gestureFailOffsetX])
    .onEnd((event) => {
      'worklet';

...
export default {
  ...
  invite_error_modal_title: 'Техническая ошибка при отправке письма',
  invite_error_modal_message: 'Письмо не удалось отправить. Ссылка-приглашение скопирована в буфер обмена. Вы можете поделиться ей с сотрудником или установить пароль вручную.',
  invite_error_copy_link: 'Скопировать ссылку',
  invite_error_goto_users: 'К списку',

...
export default {
  ...
  'months_genitive.0': 'января',
  'months_genitive.1': 'февраля',
  'months_genitive.2': 'марта',
  'months_genitive.3': 'апреля',
  'months_genitive.4': 'мая',
  'months_genitive.5': 'июня',
  'months_genitive.6': 'июля',
  'months_genitive.7': 'августа',
  'months_genitive.8': 'сентября',
  'months_genitive.9': 'октября',
  'months_genitive.10': 'ноября',
  'months_genitive.11': 'декабря',

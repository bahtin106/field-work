  ...
  components: {
    ...
    button: {
      palette: {
        ...
        outline: { bg: '#FFFFFF', fg: '#007AFF', border: '#007AFF' },
        ghost: { bg: '#FFFFFF', fg: '#0A0A0A', border: '#E5E7EB' },
    ...
    iconButton: {
      ...
      radius: { sm: 'sm', md: 'md', lg: 'lg' },
      palette: {
        primary: {
          bg: { ref: 'primary', alpha: 0.04 },
          border: { ref: 'primary', alpha: 0.3 },
          ripple: { ref: 'primary', alpha: 0.12 },
          icon: 'primary',
        },
        secondary: {
          bg: 'transparent',
        ...
        destructive: {
          bg: 'danger',
          border: 'danger',
          ripple: { ref: 'onPrimary', alpha: 0.3 },
          icon: 'onPrimary',
        },
      },
      disabledOpacity: 0.5,
    ...
    filtersPanel: {
      openSpring: { damping: 28, stiffness: 260, mass: 0.85 },
      closeDuration: 280,
      swipeEdgeWidth: 32,
      swipeCloseRatio: 0.25,
      swipeCloseVelocity: 0.55,
      minColumnRatio: 0.2,
      maxColumnRatio: 0.5,
    },
    ...
    datetimeModal: {
      ...
      innerGap: 8,
      wheelMinWidth: 64,
      segmentedBorderWidth: 1,
      segmentedRadius: 12,
      segmentedPaddingY: 8,
      segmentedActiveAlpha: 0.12,
      segmentedPressedOpacity: 0.85,
      wheelSectionGap: 10,
      selectionBackgroundAlpha: 0.06,
      selectionBorderWidth: 1,
      selectionBorderAlpha: 0.22,
      selectionRadius: 12,
      omitYearPaddingX: 4,
      omitYearPaddingLeft: 12,
      omitYearPaddingY: 6,
      omitYearTextSize: 15,
      omitYearSpacerWidth: 12,
    },
    authRegister: {
  ...
  components: {
    ...
    button: {
      palette: {
        ...
        outline: { bg: '#141720', fg: '#2E7BFF', border: '#2E7BFF' },
        ghost: { bg: '#141720', fg: '#F3F5F8', border: '#2B3140' },

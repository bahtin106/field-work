-- Keep manual/admin block markers when assigning a seat.
-- This prevents auto-unblocking manually blocked users during seat recalculation.
...
BEGIN
  ...
  -- assign_seat is an explicit admin unblock action:
  -- keep block only for hard admin/suspension flags, but clear manual markers.

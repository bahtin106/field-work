-- Preserve paid seats on manual renewal when seats were not intentionally changed.
-- This prevents accidental reset to base seat (1) when super-admin only extends period.
...
BEGIN
  ...
  -- Safety net:
  -- 1) expired -> active renewal should preserve historical seats
  -- 2) active -> expired cancel should preserve historical seats
  -- when caller sends 0 extra seats as part of period/status action.

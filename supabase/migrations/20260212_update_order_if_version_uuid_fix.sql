-- Fix type casts in optimistic-concurrency RPC for UUID-based foreign keys.
-- Some environments have orders.department_id/work_type_id as uuid, while
-- previous function version casted these patch fields to int.

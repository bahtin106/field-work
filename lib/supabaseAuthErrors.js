...
export const AUTH_ERRORS = {
  ...
  CLIENT_UPDATE_REQUIRED: 'errors_client_update_required',
...
export function mapSupabaseAuthError(error) {
  ...
  if (
    ...
    normalizedMessage.includes('invalid apikey') ||
    normalizedMessage.includes('apikey is invalid') ||
    normalizedMessage.includes('jwt is invalid')
  ) {
    return AUTH_ERRORS.CLIENT_UPDATE_REQUIRED;
  }

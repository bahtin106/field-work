...
// Keep the validated React Native KAV on iOS: it resets from native keyboard
// notifications and avoids the missed-final-frame behavior seen in the
// controller implementation. Android continues to use the native controller.

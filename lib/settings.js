...
const FIELD_CATALOG = [
  ...
  { key: 'payment_method', label: 'Способ оплаты', type: 'select', position: 300 },
  { key: 'customer_company', label: 'Компания заказчика', type: 'text', position: 310 },
];
...
// --- Полная заявка + payout (если доступен) ---
...
// --- Legacy helper: сохранение custom-полей заявки ---
...
// --- Утилиты маппинга: field_key -> value в orders ---

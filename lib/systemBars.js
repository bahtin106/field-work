...
export async function applyAndroidNavigationBar(
  ...
  try {
    ...
    if (typeof NavigationBar.NavigationBar?.setHidden === 'function') {
      NavigationBar.NavigationBar.setHidden(false);
    }
    if (typeof NavigationBar.NavigationBar?.setStyle === 'function') {
      NavigationBar.NavigationBar.setStyle(buttonStyle);
    }
  } catch {}
}

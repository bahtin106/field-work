...
export const PERM_KEYS = {
  ...
  CAN_COMPLETE_OWN_ORDERS: 'canCompleteOwnOrders',
  CAN_COMPLETE_OTHER_ORDERS: 'canCompleteOtherOrders',
...
export const ORDER_MEDIA = {
  CATEGORIES: ['media_file_1', 'media_file_2', 'media_file_3', 'media_file_4'],
};
...
export const FUNCTIONS = {
  ...
  REGISTER_REQUEST_CODE: 'register-request-code',
  REGISTER_VERIFY_CODE: 'register-verify-code',
  SWITCH_ACCOUNT_MODE: 'switch-account-mode',
  DELETE_USERAliases: [],
};

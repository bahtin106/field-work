  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        chip: {
          marginLeft: 8,
          backgroundColor: theme.mode === 'dark' ? theme.chip.bg : '#e7f0ff',
          paddingVertical: 6,
        ...
        monthCell: {
          width: '31%',
          backgroundColor: theme.mode === 'dark' ? theme.colors.card : theme.colors.bg,
          borderRadius: 12,
          paddingVertical: 12,
          alignItems: 'center',
          marginBottom: 10,
        ...
        searchInput: {
          backgroundColor: theme.colors.surface ? theme.colors.surface[1] : theme.colors.card,
          borderColor: theme.colors.border,
          borderWidth: 1,
          borderRadius: 12,
          paddingVertical: 10,
        ...
        executorRowSelected: {
          backgroundColor: theme.mode === 'dark' ? theme.chip?.bg || '#1C2230' : '#f0f8ff',
          borderRadius: 10,
          paddingVertical: 10,
          paddingHorizontal: 12,
        },
        ...
        clearButton: {
          marginTop: 12,
          backgroundColor: theme.mode === 'dark' ? theme.colors.tint : '#eee',
          paddingVertical: 10,
          borderRadius: 10,
          alignItems: 'center',
        },
      ...
      <View style={styles.container}>
                ...
                <Pressable
                  ...
                  style={{
                    ...
                    backgroundColor:
                      ...
                      (theme.mode === 'dark' ? theme.colors.tint : '#eaeaea'),
                  }}
                >
                  <Text style={{ color: theme.text.muted.color, fontSize: 16, fontWeight: '700' }}>
                    ×
                  </Text>
                </Pressable>
              )}
        ...
        >
          <Pressable style={styles.modalBackdrop} onPress={closeMonthPicker}>
            <Animated.View style={[styles.modalDim, { opacity: fadeAnim }]} />
                      ...
                      >
                        ...
                        <View
                          style={[
                            styles.rolePill,
                            {
                              borderColor: roleColor(item.role) + '33',
                              backgroundColor: roleColor(item.role) + '22',
                            },
                          ]}
                        >
                          <Text
                            style={{ color: roleColor(item.role), fontSize: 12, fontWeight: '600' }}
                          >

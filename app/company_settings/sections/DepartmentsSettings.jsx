          ...
          {deleteDlg.open && (
            ...
            >
              ...
              {deleteDlg.hasEmployees ? (
                <View style={{ gap: 8 }}>
                  <Pressable
                    onPress={() => setDeleteDlg({ ...deleteDlg, action: 'delete_employees' })}
                  >
                    <Text
                      style={{
                        color:
                          deleteDlg.action === 'delete_employees'
                  ...
                  <Pressable
                    onPress={() =>
                      setDeleteDlg({ ...deleteDlg, action: 'unset_employees', target: null })
                    }
                  >
                    <Text
                      style={{
                        color:
                          deleteDlg.action === 'unset_employees'
                            ? theme.colors.primary
                            : theme.colors.text,
                      }}
                    >
                  ...
                  <View>
                    <Pressable
                      onPress={() => setDeleteDlg({ ...deleteDlg, action: 'move_employees' })}
                    >
                      <Text
                        style={{
                          color:
                    ...
                    {deleteDlg.action === 'move_employees' && (
                      <View style={{ marginTop: 8 }}>
                        {departments
                          .filter((d) => String(d.id) !== String(deleteDlg.id) && d.is_enabled)
                          .map((item) => (
                            <Pressable
                              key={String(item.id)}
                              onPress={() => setDeleteDlg({ ...deleteDlg, target: item.id })}
                              style={{ paddingVertical: 6 }}
                            >
                              <Text
                                style={{
                                  color:
                                    String(deleteDlg.target) === String(item.id)
                                      ? theme.colors.primary
                                      : theme.colors.text,
                                }}
                              >
              ...
              <View
                style={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 8, marginTop: 8 }}
              >
                <Pressable
                  onPress={() =>
                    setDeleteDlg({

...
export default function FieldEditorScreen() {
  ...
  const orderQuery = useEntityFieldSettings(ENTITY_FIELD_TYPES.ORDER, { enabled: isAdmin, refetchOnMount: 'always' });
  const objectQuery = useEntityFieldSettings(ENTITY_FIELD_TYPES.OBJECT, { enabled: isAdmin, refetchOnMount: 'always' });
  const employeeQuery = useEntityFieldSettings(ENTITY_FIELD_TYPES.EMPLOYEE, {
    enabled: isAdmin && !isSoloAdmin,
    refetchOnMount: 'always',
  });
  const clientQuery = useEntityFieldSettings(ENTITY_FIELD_TYPES.CLIENT, { enabled: isAdmin, refetchOnMount: 'always' });
